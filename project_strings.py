...
status_waiting_for_task_func_name = "Waiting for func_name of:"
...
start_message = "Hi! You can run any Python script without input here," \
                ...
                "If you want to add some tasks or tests\n"\
                "use /admin"
...
message_to = "to"
message_use_this_example = "Use this example:"
give_up = "Give up 🏳️"
message_after_example = "You can use Custom Input if you need some tabs in your code\n"\
                        "If you want to see author's solution use Give up button"
message_author_solution = "Author's solution is:"
